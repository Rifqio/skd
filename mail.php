...
$mail->Username = 'yntktsaya@gmail.com';
$mail->Password = 'herpderp';
$mail->SMTPSecure = 'ssl';
$mail->Port = 465;
//ganti dengan email yg akan di gunakan sebagai email pengirim
$mail->setFrom('yntktsaya@gmail.com', 'Rifqi Oktario');
...
$mail->Body = "Selemat, anda berhasil membuat akun. Untuk mengaktifkan akun anda silahkan klik link dibawah ini.
 <a href='http://localhost/skd/Tugas2/activation.php?t=".$token."'>http://localhost/activation.php?t=".$token."</a>  ";
$mail->send();
